...
export const mockOpeningHours: DailyOpeningHours[] = [
  ...
  { weekday: 4, closed: false, slots: [{ open: "11:30", close: "14:00" }, { open: "17:30", close: "23:30" }] },
  {
    weekday: 5,
    closed: false,
    slots: [{ open: "11:30", close: "14:00" }, { open: "17:30", close: "24:00" }],
    updatedBy: "u-manager",
...
export const mockSpecialDates: SpecialOpeningDate[] = [
  {
    ...
    publicMessage: "1. August – Grillabend im Garten",
  },
  {
    ...
    closed: true,
    slots: [],
    publicMessage: "Betriebsferien 10.–17. August",
  },
];
...
export const mockEvents: RestaurantEvent[] = [
  {
    ...
    fullDescription:
      "Wir feuern den Grill im Gartenrestaurant an und servieren saisonale Spezialitäten. Reservation empfohlen.",
    startDate: plus(7),
    startTime: "18:00",
    endDate: plus(7),
    endTime: "23:00",
  ...
  },
  {
    ...
    fullDescription: "Klassisches Wildmenu mit Beilagen aus dem Zürcher Umland.",
    startDate: plus(45),
    startTime: "18:30",
    endDate: plus(45),
    endTime: "23:00",
  ...
  },
  {
    ...
    fullDescription: "Wird im Kalender geführt.",
    startDate: plus(150),
    startTime: "18:00",
    endDate: plus(150),
    endTime: "23:00",
  ...
  // events page has a real example to exercise the upcoming/past split with.
  {
    ...
    fullDescription: "Ein entspannter Apéro zur Eröffnung der Gartensaison mit kleinen Häppchen.",
    startDate: plus(-30),
    startTime: "17:00",
    endDate: plus(-30),
    endTime: "20:00",
...
export const mockReservations: Reservation[] = [
  ...
  },
  {
    ...
    status: "CONFIRMED",
    source: "STAFF_ENTRY",
    createdBy: "u-employee",
    updatedBy: "u-employee",
...
export const mockAuditLogs: AuditLog[] = [
  {
    ...
    entityId: "r-003",
    summary: "Reservation STA-2026-000483 bestätigt",
    field: "Status",
    oldValue: "Offen",
    newValue: "Bestätigt",
    createdAt: "2026-07-20T09:00:00Z",
  ...
  },
  {
    ...
    entityId: "oh-week",
    summary: "Freitagabend-Öffnungszeit verlängert",
    field: "Freitag, Abend",
    oldValue: "17:30 – 23:00",
    newValue: "17:30 – 24:00",
  ...
  },
  {
    ...
    entityType: "Reservation",
    entityId: "r-004",
    summary: "Sitzbereich für STA-2026-000484 angepasst",
    field: "Sitzbereich",
    oldValue: "Gartenrestaurant",
    newValue: "Restaurant",
    comment: "Gast wollte drinnen sitzen, Wetterumschwung angekündigt.",
  ...
  },
  {
    ...
    entityType: "Event",
    entityId: "e-2",
    summary: "Event „Herbstliches Wildmenu” veröffentlicht",
  ...
  },
  {
    ...
    entityType: "Reservation",
    entityId: "r-007",
    summary: "Notiz zu STA-2026-000487 hinzugefügt",
    createdAt: "2026-07-24T09:20:00Z",
  },
];
