    ...
    <>
      ...
      <section className="relative isolate">
        <div className="absolute inset-0 -z-10">
          <Image
            src={heroImg}
            alt="Sternen Albisrieden Innenraum"
            fill
            sizes="100vw"
            priority
        ...
        <div className="container-page flex min-h-[78vh] flex-col justify-end pb-16 pt-32 text-primary-foreground md:min-h-[85vh]">
          ...
          <p className="mt-5 max-w-xl text-base text-primary-foreground/85">
            Traditionelle Schweizer Küche, saisonale Kreationen und ein lauschiger Garten – wir freuen uns auf
            Ihren Besuch.
          </p>
          <div className="mt-8 flex flex-wrap gap-3">
            <Button asChild size="lg" className="bg-accent text-accent-foreground hover:bg-accent/90">
              <Link href="/reservation">
                Tisch reservieren <ArrowRight className="ml-1 h-4 w-4" />
              </Link>
            </Button>
            <Button
              asChild
            ...
            >
              <Link href="/speisekarte">Speisekarte entdecken</Link>
            </Button>
          </div>
