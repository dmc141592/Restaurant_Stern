// Demo dataset. All content marked with `demo` MUST be reviewed before going
// public. This module is the single source of frontend truth and will be
// replaced with Prisma queries during the Next.js migration.
