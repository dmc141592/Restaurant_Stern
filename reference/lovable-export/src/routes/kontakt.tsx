...
export const Route = createFileRoute("/kontakt")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "So erreichen Sie uns: Adresse, Telefon, E-Mail und Anfahrt mit öffentlichem Verkehr." },
      { property: "og:title", content: "Kontakt & Anfahrt – Sternen Albisrieden" },
      { property: "og:description", content: "Adresse, Telefon und Anfahrt zum Restaurant Sternen Albisrieden." },
    ],
  }),
  component: Page,
});
          ...
          <div className="space-y-5 text-sm">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-muted-foreground">Albisriederstrasse 000<br />8047 Zürich</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
            ...
            <div className="flex items-start gap-3">
              ...
              <a href="mailto:info@sternenalbisrieden.demo" className="hover:underline">info@sternenalbisrieden.demo</a>
            </div>
            <div className="flex items-start gap-3">
              <TramFront className="mt-0.5 h-5 w-5 text-primary" />
              <p className="text-muted-foreground">Anfahrt mit Tram und Bus – Haltestelle in wenigen Gehminuten (Platzhalter).</p>
            </div>
            <a
